...
<head>
    ...
    <title>Welcome to Reena Bank</title>
</head>
<body>
      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block external-img" class="d-block w-100 img-fluid"  alt="...">
              <h5>Reena Bank</h5>
          ...
          <div class="carousel-item">
            <img src="./img/bank3.jpg" class="d-block w-100 img-fluid"  alt="...">
            <div class="carousel-caption d-none d-md-block external-img">
      ...
      <!-- CArosoul part end -->
        ...
        <div class="container my-5">
            ...
            <div class="row row-cols-2">       
              ...
              <div class="col">
              <img src="./img/services.jpg" class="rounded img-fluid float-right" alt="...">
              </div>
            </div>
            </section>
      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 " >
            <p>
            At Reena Bank, we're more than just a financial institution; we're your trusted partner in achieving your financial goals. With a legacy of reliability and innovation, we provide personalized banking solutions tailored to your needs. Our commitment to integrity, excellence, and customer satisfaction drives everything we do. Experience banking that goes beyond transactions - experience Reena Bank.
            </p>
